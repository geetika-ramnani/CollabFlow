            ...
            <section className="home-page">
                ...
                <div className="bg-gradient-hero">
                    ...
                    <section className="hero-secrion">
                        ...
                        <div className="text">
                            <h1>CollabFlow brings all your tasks, teammates, and tools together</h1>
                ...
                <div className="bg-gradient-101">
                    ...
                    <section className="collabflow-101">

                        <div className="prod-div">

                            <h5>CollabFlow 101</h5>
                        ...
                        <div className="prod-cards-div">
                            ...
                            <button className="cards-btn card-boards" >
                                <h5>Boards</h5>
                                <p>CollabFlow boards keep tasks organized and work moving forward. ln a glance, see everything from "things to do" to "aww yeah, we did it!"</p>
                                <div></div>
                            </button>
                            ...
                            <button className="cards-btn card-lists">
                                <h5>Lists</h5>
                                <p>The different stages of a task. Start as simple as To Do, Doing or Done-or build a workflow custom fit to your team's needs. There's no wrong way to CollabFlow. </p>
                                <div></div>
                            </button>
