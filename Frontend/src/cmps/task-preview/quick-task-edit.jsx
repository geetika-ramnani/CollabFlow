...
import { saveTask, removeTask } from '../../store/board.slice'
...
export function QuickTaskEdit({ refDataBtn, task, taskId, groupId, boardId, toggleQuickTaskEdit }) {
    ...
    async function onSaveEdit() {
        try {
            await dispatch(saveTask({ task: taskToEdit, groupId, boardId }))
        } catch (err) {
    ...
    async function onRemoveTask() {
        try {
            await dispatch(removeTask({ taskId, groupId, boardId }))
